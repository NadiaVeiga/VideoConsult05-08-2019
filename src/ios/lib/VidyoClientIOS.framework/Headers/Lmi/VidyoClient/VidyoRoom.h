...
/**
 {callback apigroup="simple":
 	...
 	{parent: VidyoRoom}
 	{description: }
 	{prototype: void (*VidyoRoomOnRequestRoleChangeResult)(const VidyoRoom* room, VidyoRoomRequestRoleChangeResult result, const LmiString* userContext)}
 	{parameter:
 		{name: room}
 		{description: Pointer to the VidyoRoom that triggered the callback. }
 	}
 ...
 */
typedef void (*VidyoRoomOnRequestRoleChangeResult)(const VidyoRoom* room, VidyoRoomRequestRoleChangeResult result, const LmiString* userContext);
...
/**
 {function:
 	...
 	{prototype: LmiBool VidyoRoomRequestRoleChange(const VidyoRoom* room, VidyoRole newRole, const VidyoRoleAuthorization* auth, VidyoRoomOnRequestRoleChangeResult onRequestRoleChangeResult, const LmiString* userContext)}
 	...
 	{parameter: {name: userContext} {description: .}}
 	{return: LMI_TRUE if successful, LMI_FALSE otherwise.}
 }
*/
LmiBool VidyoRoomRequestRoleChange(const VidyoRoom* room, VidyoRole newRole, const VidyoRoleAuthorization* auth, VidyoRoomOnRequestRoleChangeResult onRequestRoleChangeResult, const LmiString* userContext);

/**
{type apigroup="simple" visibility="public":
    {name: VidyoRoomSetRoleChangeAuthorizationResult}
    {parent: VidyoRoom}
    {description: This type indicates the result of setting role authorization.}
    {value: {name: VIDYO_ROOMSETROLECHANGEAUTHORIZATIONRESULT_OK} {description: Set role authentication was successful.}}
    {value: {name: VIDYO_ROOMSETROLECHANGEAUTHORIZATIONRESULT_NoResponse} {description: The server did not respond in a reasonable amount of time.}}
    {value: {name: VIDYO_ROOMSETROLECHANGEAUTHORIZATIONRESULT_Unauthorized} {description: The user did not have permission to set role change authorization.}}
    {value: {name: VIDYO_ROOMSETROLECHANGEAUTHORIZATIONRESULT_InvalidInput} {description: The input of role change authorization is invalid.}}
    {value: {name: VIDYO_ROOMSETROLECHANGEAUTHORIZATIONRESULT_MiscLocalError} {description: Set role change authorization failed due to some miscellaneous problem with the request.}}
    {value: {name: VIDYO_ROOMSETROLECHANGEAUTHORIZATIONRESULT_MiscRemoteError} {description: The server is rejecting the set role change authorization request due to some miscellaneous problem of its own.}}
}
*/
typedef enum
{
...
} VidyoRoomSetRoleChangeAuthorizationResult;

/**
{callback apigroup="simple":
    {name: VidyoRoomOnSetRoleChangeAuthorizationResult}
    {parent: VidyoRoom}
    {description: }
    {prototype: void (*VidyoRoomOnSetRoleChangeAuthorizationResult)(const VidyoRoom* room, VidyoRoomSetRoleChangeAuthorizationResult result, const LmiString* userContext)}
    {parameter:
        {name: room}
        {description: Pointer to the VidyoRoom that triggered the callback. }
    }
    {parameter:
        {name: result}
        {description: Result of the set role change authorization request.}
    }
    {parameter:
        {name: userContext}
        {description: The same unique string passed in VidyoRoomSetRoleChangeAuthorization.}
    }
}
*/
typedef void (*VidyoRoomOnSetRoleChangeAuthorizationResult)(const VidyoRoom* room, VidyoRoomSetRoleChangeAuthorizationResult result, const LmiString* userContext);
...
{function:
    ...
    {prototype: LmiBool VidyoRoomSetRoleChangeAuthorization(VidyoRoom* room, VidyoRole role, const VidyoRoleAuthorization* auth, VidyoRoomOnSetRoleChangeAuthorizationResult onSetRoleAuthorizationResult, const LmiString* userContext)}
    {parameter: {name: room} {description: Vidyo room object.}}
    ...
    {parameter: {name: onSetRoleAuthorizationResult} {description: Callback to be triggered when setting of role authentication is completed.}}
    {parameter: {name: userContext} {description: An application provided unique string that will be passed int onSetRoleAuthorizationResult callback.}}
    {return: LMI_TRUE if successful, LMI_FALSE otherwise.}
}
*/
LmiBool VidyoRoomSetRoleChangeAuthorization(VidyoRoom* room, VidyoRole role, const VidyoRoleAuthorization* auth, VidyoRoomOnSetRoleChangeAuthorizationResult onSetRoleAuthorizationResult, const LmiString* userContext);

/**
{type apigroup="simple" visibility="public":
    {name: VidyoRoomRemoveRoleChangeAuthorizationResult}
    {parent: VidyoRoom}
    {description: This type indicates the result of removing role change authorization.}
    {value: {name: VIDYO_ROOMREMOVEROLECHANGEAUTHORIZATIONRESULT_OK} {description: Remove role authentication was successful.}}
    {value: {name: VIDYO_ROOMREMOVEROLECHANGEAUTHORIZATIONRESULT_NoResponse} {description: The server did not respond in a reasonable amount of time.}}
    {value: {name: VIDYO_ROOMREMOVEROLECHANGEAUTHORIZATIONRESULT_Unauthorized} {description: The user did not have permission to remove role change authorization.}}
    {value: {name: VIDYO_ROOMREMOVEROLECHANGEAUTHORIZATIONRESULT_MiscLocalError} {description: Remove role change authroization failed due to some miscellaneous problem with the request.}}
    {value: {name: VIDYO_ROOMREMOVEROLECHANGEAUTHORIZATIONRESULT_MiscRemoteError} {description: The server is rejecting the remove role change authorization request due to some miscellaneous problem of its own.}}
}
*/
typedef enum
{
...
} VidyoRoomRemoveRoleChangeAuthorizationResult;

/**
{callback apigroup="simple":
    {name: VidyoRoomOnRemoveRoleChangeAuthorizationResult}
    {parent: VidyoRoom}
    {description: }
    {prototype: void (*VidyoRoomOnRemoveRoleChangeAuthorizationResult)(const VidyoRoom* room, VidyoRoomRemoveRoleChangeAuthorizationResult result, const LmiString* userContext)}
    {parameter:
        {name: room}
        {description: Pointer to the VidyoRoom that triggered the callback. }
    }
    {parameter:
        {name: result}
        {description: Result of the remove role change authorization request.}
    }
    {parameter:
        {name: userContext}
        {description: The same unique string passed in VidyoRoomRemoveRoleChangeAuthorization.}
    }
}
*/
typedef void (*VidyoRoomOnRemoveRoleChangeAuthorizationResult)(const VidyoRoom* room, VidyoRoomRemoveRoleChangeAuthorizationResult result, const LmiString* userContext);
...
{function:
    ...
    {prototype: LmiBool VidyoRoomRemoveRoleChangeAuthorization(VidyoRoom* room, VidyoRole role, VidyoRoomOnRemoveRoleChangeAuthorizationResult onRemoveRoleChangeAuthorizationResult, const LmiString* userContext)}
    {parameter: {name: room} {description: Vidyo room object.}}
    {parameter: {name: role} {description: VidyoRole that provided auth is assoicted with.}}
    {parameter: {name: onRemoveRoleChangeAuthorizationResult} {description: Callback to be triggered when setting of role authentication is completed.}}
    {parameter: {name: userContext} {description: An application provided unique string that will be passed int onSetRoleAuthorizationResult callback.}}
    {return: LMI_TRUE if successful, LMI_FALSE otherwise.}
}
*/
LmiBool VidyoRoomRemoveRoleChangeAuthorization(VidyoRoom* room, VidyoRole role, VidyoRoomOnRemoveRoleChangeAuthorizationResult onRemoveRoleChangeAuthorizationResult, const LmiString* userContext);
...
{callback apigroup="simple":
    ...
    {parent: VidyoRoom}
    {description: }
    {prototype: void (*VidyoRoomOnModerationResult)(const VidyoRoom* room, VidyoRoomModerationResult result, const LmiString* userContext)}
    {parameter:
        {name: room}
        {description: Pointer to the VidyoRoom that triggered the callback. }
    }
...
*/
typedef void (*VidyoRoomOnModerationResult)(const VidyoRoom* room, VidyoRoomModerationResult result, const LmiString* userContext);
...
{function:
    ...
    {prototype: LmiBool VidyoRoomRevokeAudioForAll(VidyoRoom* room, LmiBool revoke, const LmiString* userContext)}
    {parameter: {name: room} {description: Vidyo room object.}}
    ...
    {parameter: {name: userContext} {description: Application provide identifier to track this request.}}
    {return: LMI_TRUE if successful, LMI_FALSE otherwise.}
}
*/
LmiBool VidyoRoomRevokeAudioForAll(VidyoRoom* room, LmiBool revoke, const LmiString* userContext);
...
{function:
    ...
    {prototype: LmiBool VidyoRoomRevokeAudioForParticipant(VidyoRoom* room, const LmiString* userId, LmiBool revoke, const LmiString* userContext)}
    {parameter: {name: room} {description: Vidyo room object.}}
...
*/
LmiBool VidyoRoomRevokeAudioForParticipant(VidyoRoom* room, const LmiString* userId, LmiBool revoke, const LmiString* userContext);
...
{function:
    ...
    {prototype: LmiBool VidyoRoomRevokeVideoForAll(VidyoRoom* room, LmiBool revoke, const LmiString* userContext)}
    {parameter: {name: room} {description: Vidyo room object.}}
...
*/
LmiBool VidyoRoomRevokeVideoForAll(VidyoRoom* room, LmiBool revoke, const LmiString* userContext);
...
{function:
    ...
    {prototype: LmiBool VidyoRoomRevokeVideoForParticipant(VidyoRoom* room, const LmiString* userId, LmiBool revoke, const LmiString* userContext)}
    {parameter: {name: room} {description: Vidyo room object.}}
    {parameter: {name: userId} {description: The ID of participant whose audio is revoked/resumed.}}
...
*/
LmiBool VidyoRoomRevokeVideoForParticipant(VidyoRoom* room, const LmiString* userId, LmiBool revoke, const LmiString* userContext);
...
{function:
    ...
    {prototype: LmiBool VidyoRoomRequestAudioSilenceForAll(VidyoRoom* room, const LmiString* userContext)}
    {parameter: {name: room} {description: Vidyo room object.}}
    {parameter: {name: userContext} {description: Application provide identifier to track this request.}}
    {return: LMI_TRUE if successful, LMI_FALSE otherwise.}
}
*/
LmiBool  VidyoRoomRequestAudioSilenceForAll(VidyoRoom* room, const LmiString* userContext);
...
{function:
    ...
    {prototype: LmiBool VidyoRoomRequestAudioSilenceForParticipant(VidyoRoom* room, const LmiString* userId, const LmiString* userContext)}
    {parameter: {name: room} {description: Vidyo room object.}}
...
*/
LmiBool  VidyoRoomRequestAudioSilenceForParticipant(VidyoRoom* room, const LmiString* userId, const LmiString* userContext);
...
{function:
    ...
    {prototype: LmiBool VidyoRoomRequestVideoSilenceForAll(VidyoRoom* room, const LmiString* userContext)}
    {parameter: {name: room} {description: Vidyo room object.}}
    {parameter: {name: userContext} {description: Application provide identifier to track this request.}}
    {return: LMI_TRUE if successful, LMI_FALSE otherwise.}
}
*/
LmiBool  VidyoRoomRequestVideoSilenceForAll(VidyoRoom* room, const LmiString* userContext);
...
{function:
    ...
    {prototype: LmiBool VidyoRoomRequestVideoSilenceForParticipant(VidyoRoom* room, const LmiString* userId, const LmiString* userContext)}
    {parameter: {name: room} {description: Vidyo room object.}}
...
*/
LmiBool  VidyoRoomRequestVideoSilenceForParticipant(VidyoRoom* room, const LmiString* userId, const LmiString* userContext);
