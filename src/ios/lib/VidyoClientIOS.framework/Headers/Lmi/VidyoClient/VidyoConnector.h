...
{function apigroup="connector":
    ...
    {parent: VidyoConnector}
    {description: Sets the max send bit rate for all sources. }
    {prototype: void VidyoConnectorSetMaxSendBitRate(VidyoConnector* c, LmiUint bitRate)}
    {parameter:
        {name: c}
        {description: The VidyoConnector object.}
    }
 ...
 */
void VidyoConnectorSetMaxSendBitRate(VidyoConnector* c, LmiUint bitRate);
...
{function apigroup="beta,enterprise":
    ...
    {prototype: void VidyoConnectorSetMaxReceiveBitRate(VidyoConnector* c, LmiUint bitRate)}
    {parameter:
        {name: c}
        {description: The VidyoConnector object.}
    }
...
*/
void VidyoConnectorSetMaxReceiveBitRate(VidyoConnector* c, LmiUint bitRate);
...
/**
 {function apigroup="connector":
	...
	{parent: VidyoConnector}
	{description: Sets the flag to show/hide the local camera preview for composite layout only.}
...
{function apigroup="beta,enterprise":
 	...
 	{parent: VidyoConnector}
 	{description: Registers to get notified about remote speaker events.}
...
{function apigroup="beta,enterprise":
 	...
 	{parent: VidyoConnector}
 	{description: Registers to get notified about remote renderer events.}
...
/**
 {function apigroup="connector":
    ...
    {parent: VidyoConnector}
    {description: Shows a VidyoVirtualVideoSource in a view.}
...
{function apigroup="connector":
 	...
 	{parent: VidyoConnector}
 	{description: Enable the use of WebProxy Transport with provided web proxy server address.}
...
{function apigroup="connector":
 	...
 	{parent: VidyoConnector}
 	{description: By default, local participant joining/leaving are not reported to applicaiotn. Use this function to report those events.}
...
{function apigroup="connector":
    ...
    {parent: VidyoConnector}
    {description: Create virtual video source. The user can create a maximum of 10 virtual video sources.}
...
{function apigroup="connector":
    ...
    {prototype: LmiBool VidyoConnectorDestroyVirtualVideoSource(VidyoConnector* c, VidyoVirtualVideoSource* virtualVideoSource)}
    {parameter:
        {name: c}
        {description: The VidyoConnector object.}
    }
...
*/
LmiBool VidyoConnectorDestroyVirtualVideoSource(VidyoConnector* c, VidyoVirtualVideoSource* virtualVideoSource);

/**
{function apigroup="connector":
    {name: VidyoConnectorSelectVirtualCamera}
    {parent: VidyoConnector}
    {description: Selects the virtual video source which is camera that will be shown to remote participants. The real camera will be unselected if it's selected.}
    {prototype: LmiBool VidyoConnectorSelectVirtualCamera(VidyoConnector* c, VidyoVirtualVideoSource* virtualCamera)}
    {parameter:
        {name: c}
        {description: The VidyoConnector object.}
    }
...
*/
LmiBool VidyoConnectorSelectVirtualCamera(VidyoConnector* c, VidyoVirtualVideoSource* virtualCamera);

/**
{function apigroup="connector":
    {name: VidyoConnectorSelectVirtualWindowShare}
    {parent: VidyoConnector}
    ...
    {prototype: LmiBool VidyoConnectorSelectVirtualWindowShare(VidyoConnector* c, VidyoVirtualVideoSource* virtualWindowShare)}
    {parameter:
        {name: c}
        {description: The VidyoConnector object.}
    }
...
*/
LmiBool VidyoConnectorSelectVirtualWindowShare(VidyoConnector* c, VidyoVirtualVideoSource* virtualWindowShare);
...
{function apigroup="connector":
    ...
    {parent: VidyoConnector}
    {description: Get the local renderer and conference tiles displaying options.}
