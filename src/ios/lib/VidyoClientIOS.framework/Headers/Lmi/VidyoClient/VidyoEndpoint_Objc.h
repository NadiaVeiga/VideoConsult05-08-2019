...
typedef NS_ENUM(NSInteger, VCRoomRemoveRoleChangeAuthorizationResult){
	VCRoomRemoveRoleChangeAuthorizationResultOK,
	VCRoomRemoveRoleChangeAuthorizationResultNoResponse,
	VCRoomRemoveRoleChangeAuthorizationResultUnauthorized,
	VCRoomRemoveRoleChangeAuthorizationResultMiscLocalError,
	VCRoomRemoveRoleChangeAuthorizationResultMiscRemoteError
};
...
typedef NS_ENUM(NSInteger, VCRoomSetRoleChangeAuthorizationResult){
	VCRoomSetRoleChangeAuthorizationResultOK,
	VCRoomSetRoleChangeAuthorizationResultNoResponse,
	VCRoomSetRoleChangeAuthorizationResultUnauthorized,
	VCRoomSetRoleChangeAuthorizationResultInvalidInput,
	VCRoomSetRoleChangeAuthorizationResultMiscLocalError,
	VCRoomSetRoleChangeAuthorizationResultMiscRemoteError
};
...
@interface VCEndpoint : NSObject
{
	...
	-(BOOL) selectVirtualWindowShare:(VCVirtualVideoSource*)virtualWindowShare;
	...
	-(void) virtualWindowShareSelectAdvanced:(VCVirtualVideoSource*)virtualWindowShare;
	-(id) initWithObject:(void*)rPtr;
	-(void*)getObjectPtr;
@end
...
@protocol VCRoomIRegisterModerationResultEventListener
	...
	-(void) onModerationResult:(VCRoomModerationResult)result UserContext:(NSString*)userContext;
@end
...
@end
@protocol VCRoomIRemoveRoleChangeAuthorization

	-(void) onRemoveRoleChangeAuthorizationResult:(VCRoomRemoveRoleChangeAuthorizationResult)result UserContext:(NSString*)userContext;
@end
@protocol VCRoomIRequestRoleChange

	-(void) onRequestRoleChangeResult:(VCRoomRequestRoleChangeResult)result UserContext:(NSString*)userContext;
@end
@protocol VCRoomISetFavorite

	-(void) onSetFavoriteResult:(BOOL)isFavorite Result:(VCRoomSetFavoriteResult)result;
@end
@protocol VCRoomISetRoleChangeAuthorization

	-(void) onSetRoleChangeAuthorizationResult:(VCRoomSetRoleChangeAuthorizationResult)result UserContext:(NSString*)userContext;
@end
...
@interface VCRoom : NSObject
{
	...
	id<VCRoomIRemoveRoleChangeAuthorization> roomIRemoveRoleChangeAuthorization;
	id<VCRoomIRequestRoleChange> roomIRequestRoleChange;
	id<VCRoomISetFavorite> roomISetFavorite;
	id<VCRoomISetRoleChangeAuthorization> roomISetRoleChangeAuthorization;
	...
	-(BOOL) removeRoleChangeAuthorization:(VCRole)role RoomIRemoveRoleChangeAuthorization:(id<VCRoomIRemoveRoleChangeAuthorization>)roomIRemoveRoleChangeAuthorization UserContext:(NSString*)userContext;
	...
	-(BOOL) requestAudioSilenceForAll:(NSString*)userContext;
	-(BOOL) requestAudioSilenceForParticipant:(NSString*)userId UserContext:(NSString*)userContext;
	-(BOOL) requestRoleChange:(VCRole)newRole Auth:(VCRoleAuthorization*)auth RoomIRequestRoleChange:(id<VCRoomIRequestRoleChange>)roomIRequestRoleChange UserContext:(NSString*)userContext;
	-(BOOL) requestVideoSilenceForAll:(NSString*)userContext;
	-(BOOL) requestVideoSilenceForParticipant:(NSString*)userId UserContext:(NSString*)userContext;
	-(void) resizeStatisticsDialog:(int)width Height:(int)height;
	-(BOOL) revokeAudioForAll:(BOOL)revoke UserContext:(NSString*)userContext;
	-(BOOL) revokeAudioForParticipant:(NSString*)userId Revoke:(BOOL)revoke UserContext:(NSString*)userContext;
	-(BOOL) revokeVideoForAll:(BOOL)revoke UserContext:(NSString*)userContext;
	-(BOOL) revokeVideoForParticipant:(NSString*)userId Revoke:(BOOL)revoke UserContext:(NSString*)userContext;
	-(BOOL) sendMessage:(const char*)message;
	...
	-(BOOL) setRoleChangeAuthorization:(VCRole)role Auth:(VCRoleAuthorization*)auth RoomISetRoleChangeAuthorization:(id<VCRoomISetRoleChangeAuthorization>)roomISetRoleChangeAuthorization UserContext:(NSString*)userContext;
