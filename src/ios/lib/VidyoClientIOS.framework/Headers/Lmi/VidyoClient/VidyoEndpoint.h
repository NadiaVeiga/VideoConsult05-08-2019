...
/**
 {function apigroup="simple":
	...
	{parent: VidyoEndpoint}
	{description: Sets the flag to show/hide the camera preview for composite layout only.}
...
/**
 {function apigroup="simple":
	...
	{parent: VidyoEndpoint}
	{description: Sets the flag to show/hide the local camera for remote participants for composite/custom layout and local camera preview for composite layout only.}
...
/**
 {function apigroup="simple":
    ...
    {parent: VidyoEndpoint}
    {description: Shows a virtual video source in a view.}
    {prototype: LmiBool VidyoEndpointAssignViewToVirtualVideoSource(const VidyoEndpoint* e, const LmiViewId* viewId, const VidyoVirtualVideoSource* virtualVideoSource, LmiBool displayCropped, LmiBool allowZoom)}
    {parameter:
        {name: e}
        {description: The VidyoEndpoint object.}
    }
...
*/
LmiBool VidyoEndpointAssignViewToVirtualVideoSource(const VidyoEndpoint* e, const LmiViewId* viewId, const VidyoVirtualVideoSource* virtualVideoSource, LmiBool displayCropped, LmiBool allowZoom);
...
{function:
	...
	{parent: VidyoEndpoint}
	{description: Select a specific virtual video source which is a camera and add it to all remote renderers. The real camera will be unselected.}
...
/**
{function:
    {name: VidyoEndpointVirtualWindowShareSelectAdvanced}
    {parent: VidyoEndpoint}
    {description: Select a specific virtual video source which is a window share and add it to all remote renderers. The local window share will be unselected.}
    {prototype: void VidyoEndpointVirtualWindowShareSelectAdvanced(VidyoEndpoint *e, const VidyoVirtualVideoSource *virtualWindowShare)}
    {parameter:
        {name: e}
        {description: The VidyoEndpoint object.}
    }
...
*/
void VidyoEndpointVirtualWindowShareSelectAdvanced(VidyoEndpoint *e, const VidyoVirtualVideoSource *virtualWindowShare);

/**
{function:
	{name: VidyoEndpointVirtualVideoSourceUnselectAdvanced}
	{parent: VidyoEndpoint}
	{description: Unselect a specific virtual video source.}
...
{function:
    ...
    {parent: VidyoEndpoint}
    {description: Set font file name.}
...
{function:
 	...
 	{parent: VidyoEndpoint}
 	{description: Request to speak after sever paused audio stream from selected local microphone.}
...
{function:
 	...
 	{parent: VidyoEndpoint}
 	{description: Request to resume sending video after sever paused video stream from selected local camera.}
...
{function apigroup="simple":
    ...
    {parent: VidyoEndpoint}
    {description: Registers to get notified about virtual video source events.}
...
{function apigroup="simple":
    ...
    {parent: VidyoEndpoint}
    {description: Unregisters virtual video source event notifications.}
...
{function:
    ...
    {parent: VidyoEndpoint}
    {description: Create a virtual video source. The user can create a maximum of 10 virtual video sources.}
...
{function:
    ...
    {parent: VidyoEndpoint}
    {description: Destroy virtual video source.}
    {prototype: LmiBool VidyoEndpointDestroyVirtualVideoSource(VidyoEndpoint* e, VidyoVirtualVideoSource* virtualVideoSource)}
    {parameter:
        {name: e}
        {description: The VidyoEndpoint object.}
    }
...
*/
LmiBool VidyoEndpointDestroyVirtualVideoSource(VidyoEndpoint* e, VidyoVirtualVideoSource* virtualVideoSource);

/**
{function:
    {name: VidyoEndpointSelectVirtualCamera}
    {parent: VidyoEndpoint}
    {description: Selects the virtual video source that will be shown to remote participants. The real camera will be unselected if it's selected.}
    {prototype: LmiBool VidyoEndpointSelectVirtualCamera(VidyoEndpoint* e, VidyoVirtualVideoSource* virtualCamera)}
    {parameter:
        {name: e}
        {description: The VidyoEndpoint object.}
    }
...
*/
LmiBool VidyoEndpointSelectVirtualCamera(VidyoEndpoint* e, VidyoVirtualVideoSource* virtualCamera);

/**
{function:
    {name: VidyoEndpointSelectVirtualWindowShare}
    {parent: VidyoEndpoint}
    {description: Selects the virtual video source which is window share that will be shown to remote participants. The local window share will be unselected if it's selected.}
    {prototype: LmiBool VidyoEndpointSelectVirtualWindowShare(VidyoEndpoint* e, VidyoVirtualVideoSource* virtualWindowShare)}
    {parameter:
        {name: e}
        {description: The VidyoEndpoint object.}
    }
...
*/
LmiBool VidyoEndpointSelectVirtualWindowShare(VidyoEndpoint* e, VidyoVirtualVideoSource* virtualWindowShare);
...
{function:
    ...
    {parameter:
        {name: options}
        {description:
        {p: A char array that contains options in the JSON format}
        {p: Keys and values are case-sensitive. List of supported keys and their values:}
        {p: Key: 'EnableVerticalVideoCentering'; Values: 'true', 'false'.}
        {p: Key: 'EnableFECCIconCustomLayout'; Values: 'true', 'false'.}
        {p: Example: '&#123'EnableVerticalVideoCentering':true, 'EnableFECCIconCustomLayout':false&#125'.}}
    }
    {return: LMI_TRUE on success, LMI_FALSE on failure.}
}
*/
